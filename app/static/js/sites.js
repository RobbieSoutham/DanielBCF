function ajax_insert(item){
    btn1 = "<button type='button' class='buttons' id='edit' onclick='edit(\"" + item.name + "\", \"" + item.address + "\");'><img src='" + $SCRIPT_ROOT + "/static/open-iconic-master/svg/pencil.svg' alt='pencil'></button>"; 
    btn2 = "<button class='buttons' id='delete' onclick='delete_site(\"" + item.name + "\");'><img src='" + $SCRIPT_ROOT + "/static/open-iconic-master/svg/x.svg' alt='x'></button>";
