function ajax_insert(item){
    bttn_html = "<center><button type='btn' id='edit' onclick='edit(" + item.id + ", \"" + item.name + "\");'><img src='" + $SCRIPT_ROOT + "/static/open-iconic-master/svg/pencil.svg' alt='pencil'></button><center>"; 
